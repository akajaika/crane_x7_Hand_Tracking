...
def main():
    ...
    hand_position = node.create_publisher(Float32MultiArray, 'hand_topic', 10)
    ...
    with mp.solutions.hands.Hands(
        ...
        while True:
            ...
            if not success:
                ...
                array_points.data = [float(smoothed_WRIST_x), float(smoothed_WRIST_y), float(result_degrees), float(position), float(clamp_position)]
